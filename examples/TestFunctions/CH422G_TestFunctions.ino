 ...
 */
 /* 
  ESP32-S3 provides multi-lane hardware, currently uses GPIO8(SDA) and GPIO9(SCL) pins as I2C bus for loading IO expansion chip, 
  touch interface and I2C interface.
*/
...
//#define EXAMPLE_CHIP_CLASS ESP_IOExpander_CH422G
...
void setup()
{
    ...
    expander = new ESP_IOExpander_CH422G::~ESP_IOExpander_CH422G(CH422G,
